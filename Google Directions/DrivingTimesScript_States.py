...
fname = 'C:/TravelTimes/TravelTimesResult_TX.csv'
texta = 'OID,Raw Input,Driving Time to Plano in minutes,Driving Time to Iriving in minutes'
texta = texta + '\n'

with open('C:/TravelTimes/Texas/DriveTime_Cities.csv') as csvfile:
...
destinations = ['5543 Legacy Drive  Plano. TX','290 E. John Carpenter Freeway Irving, TX']
...
##    texta = texta + str(count) + "," + o + "," + city + "," + state + "," + str(zipc).zfill(5) + ","
    texta = texta + str(oids[count]) + "," + str(ct)
